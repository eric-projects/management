...
export class CompRich extends Vue {
  ...
  init = {
    ...
    toolbar_location: '/',
    toolbar: [], // richToolbar:'undo redo |  formatselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | lists image media table';
