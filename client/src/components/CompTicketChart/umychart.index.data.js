...
function JSIndexScript() {
  this.DataMap = new Map([
    ...
    ['ACD', this.ACD],
    ['EXPMA', this.EXPMA],
    ['EXPMA_S', this.EXPMA_S],
    ['HMA', this.HMA],
    ['LMA', this.LMA],
    ['VMA', this.VMA],
    ['AMV', this.AMV],
    ['BBIBOLL', this.BBIBOLL],
    ['ALLIGAT', this.ALLIGAT],
    ['ZX', this.ZX],
    ['XS', this.XS],
    ['XS2', this.XS2],
    ['SG-XDT', this.SG_XDT],
    ...
    ['飞龙四式', this.Dragon4_Main],
    ['飞龙四式-附图', this.Dragon4_Fig],
    ['资金分析', this.FundsAnalysis],
    ['融资占比', this.MarginProportion],
    ['负面新闻', this.NewsNegative],
    ['涨跌趋势', this.UpDownAnalyze],
    ['北上资金', this.HK2SHSZ],
    ['股东人数', this.ShareHolder],

    ['两融余额', this.Margin2],
    ['两融余额2', this.Margin3],

    ['Zealink-资金吸筹', this.Zealink_Index1],
    ['Zealink-牛熊区间', this.Zealink_Index2],
    ['Zealink-持仓信号', this.Zealink_Index3],
    ['Zealink-增减持', this.Zealink_Index4],
    ['Zealink-大宗交易', this.Zealink_Index5],
    ['Zealink-信托持股', this.Zealink_Index6],
    ['Zealink-官网新闻', this.Zealink_Index7],
    ['Zealink-高管要闻', this.Zealink_Index8],
    ['Zealink-股权质押', this.Zealink_Index9],
    ['Zealink-操盘BS点', this.Zealink_Index10],
    ['Zealink-操盘BS点2', this.Zealink_Index11],
    ...
    //五彩K线(函数COLOR_开头)
    ['五彩K线-十字星', this.COLOR_KSTAR1],
    ['五彩K线-早晨之星', this.COLOR_KSTAR2],
    ['五彩K线-黄昏之星', this.COLOR_KSTAR3],
    ['五彩K线-长十字', this.COLOR_SHI1],
    ['五彩K线-身怀六甲', this.COLOR_K220],
    ['五彩K线-三个白武士', this.COLOR_K300],
    ['五彩K线-三只乌鸦', this.COLOR_K310],
    ['五彩K线-光头阳线', this.COLOR_K380],
    ['五彩K线-光脚阴线', this.COLOR_K390],
    ['五彩K线-垂死十字', this.COLOR_K134],
    ['五彩K线-早晨十字星', this.COLOR_K140],
    ['五彩K线-黄昏十字星', this.COLOR_K150],
    ['五彩K线-射击之星', this.COLOR_K160],
    ['五彩K线-倒转锤头', this.COLOR_K165],
    ['五彩K线-锤头', this.COLOR_K170],
    ['五彩K线-吊颈', this.COLOR_K180],
    ['五彩K线-穿头破脚', this.COLOR_K190],
    ['五彩K线-出水芙蓉', this.COLOR_CSFR],
    ['五彩K线-乌云盖顶', this.COLOR_WYGD],
    ['五彩K线-曙光初现', this.COLOR_SGCJ],
    ['五彩K线-十字胎', this.COLOR_SZTAI],
    ['五彩K线-剑', this.COLOR_SWORD],
    ['五彩K线-平顶', this.COLOR_PINGDING],
    ['五彩K线-平底', this.COLOR_PINGDI],
    ['五彩K线-大阳烛', this.COLOR_DAYANZHU],
    ['五彩K线-大阴烛', this.COLOR_DAYINGZHU],

    ['五彩K线-好友反攻', this.COLOR_HYFG],
    ['五彩K线-跳空缺口', this.COLOR_TKQK],
    ['五彩K线-双飞乌鸦', this.COLOR_SFWY],
    ['五彩K线-上升三部曲', this.COLOR_SSSBQ],
    ['五彩K线-下跌三部曲', this.COLOR_XDSBQ],
    ['五彩K线-长下影', this.COLOR_CHXY],
    ['五彩K线-长上影', this.COLOR_CHSY],
    ['五彩K线-分离', this.COLOR_FENLI],

    //交易系统
    ['交易系统-BIAS', this.TRADE_BIAS],
    ['交易系统-CCI', this.TRADE_CCI],
    ['交易系统-DMI', this.TRADE_DMI],
    ['交易系统-KD', this.TRADE_KD],
    ['交易系统-BOLL', this.TRADE_BOLL],
    ['交易系统-KDJ', this.TRADE_KDJ],
    ['交易系统-MA', this.TRADE_MA],
    ['交易系统-MACD', this.TRADE_MACD],
    ['交易系统-MTM', this.TRADE_MTM],
    ['交易系统-PSY', this.TRADE_PSY],
    ['交易系统-ROC', this.TRADE_ROC],
    ['交易系统-RSI', this.TRADE_RSI],
    ['交易系统-VR', this.TRADE_VR],
    ['交易系统-DPSJ', this.TRADE_DPSJ],

    ['TEST', this.TEST], //测试用
  ]);
}

JSIndexScript.AddIndex = function(
  aryIndex //添加自定义指标
) {
...
JSIndexScript.prototype.Search = function(name) {
  ...
  this.DataMap.forEach(function(value, key) {
    if (key.indexOf('交易系统-') != 0 && key.indexOf('五彩K线-') != 0 && key.search(reg) >= 0) result.push(key);
  });
...
JSIndexScript.prototype.MA = function() {
  ...
  let data = {
    ...
    OutName: [
      { Name: 'MA1', DynamicName: 'MA{M1}' },
      { Name: 'MA2', DynamicName: 'MA{M2}' },
      { Name: 'MA3', DynamicName: 'MA{M3}' },
    ],
    //脚本
...
JSIndexScript.prototype.BBI = function() {
  let data = {
    ...
    //脚本
    Script: 'BBI:(MA(CLOSE,M1)+MA(CLOSE,M2)+MA(CLOSE,M3)+MA(CLOSE,M4))/4;',
  };
...
JSIndexScript.prototype.PBX = function() {
  let data = {
    ...
    Description: '瀑布线',
    IsMainIndex: true,
    YSpecificMaxMin: { Max: 100, Min: 1, Count: 4 },
    YSplitScale: [1, 50, 100],
    // YSpecificMaxMin: indexInfo.YSpecificMaxMin,
    // YSplitScale: indexInfo.YSplitScale,
    Args: [
      { Name: 'M1', Value: 5 },
      { Name: 'M2', Value: 5 },
      { Name: 'M3', Value: 5 },
    ...
    // PBX2:(MA(CLOSE,M2)+MA(CLOSE,M2*2)+MA(CLOSE,M2*4))/3;\n\
    // PBX3:(MA(CLOSE,M3)+MA(CLOSE,M3*2)+MA(CLOSE,M3*4))/3;\n\
    // PBX4:(MA(CLOSE,M4)+MA(CLOSE,M4*2)+MA(CLOSE,M4*4))/3;\n\
    // PBX5:(MA(CLOSE,M5)+MA(CLOSE,M5*2)+MA(CLOSE,M5*4))/3;\n\
    // PBX6:(MA(CLOSE,M6)+MA(CLOSE,M6*2)+MA(CLOSE,M6*4))/3;',
    Script:
      'PBX1:(MA(CLOSE,M1)+MA(CLOSE,M1*2)+MA(CLOSE,M1*4))/3;\n\
    PBX2:(MA(CLOSE,M2)+MA(CLOSE,M2*2)+MA(CLOSE,M2*4))/3;\n\
    PBX3:(MA(CLOSE,M3)+MA(CLOSE,M3*2)+MA(CLOSE,M3*4))/3;\n\
...
JSIndexScript.prototype.ENE = function() {
  let data = {
    ...
    //脚本
    Script: 'UPPER:(1+M1/100)*MA(CLOSE,N);\n\
...
JSIndexScript.prototype.BRAR = function() {
  let data = {
    ...
    //脚本
    Script: 'BR:SUM(MAX(0,HIGH-REF(CLOSE,1)),N)/SUM(MAX(0,REF(CLOSE,1)-LOW),N)*100;\n\
...
JSIndexScript.prototype.OBV = function() {
  let data = {
    ...
    //脚本
    Script: 'VA:=IF(CLOSE>REF(CLOSE,1),VOL,-VOL);\n\
...
JSIndexScript.prototype.PSY = function() {
  let data = {
    ...
    //脚本
    Script: 'PSY:COUNT(CLOSE>REF(CLOSE,1),N)/N*100;\r\
PSYMA:MA(PSY,M);',
  };
...
JSIndexScript.prototype.DMA = function() {
  let data = {
    ...
    //脚本
    Script: 'DIF:MA(CLOSE,N1)-MA(CLOSE,N2);\n\
DIFMA:MA(DIF,M);',
  };
...
JSIndexScript.prototype.TRIX = function() {
  let data = {
    ...
    //脚本
    Script: 'MTR:=EMA(EMA(EMA(CLOSE,N),N),N);\n\
...
JSIndexScript.prototype.ROC = function() {
  let data = {
    ...
    //脚本
    Script: 'ROC:100*(CLOSE-REF(CLOSE,N))/REF(CLOSE,N);\n\
MAROC:MA(ROC,M);',
  };
...
JSIndexScript.prototype.FSL = function() {
  let data = {
    ...
    Args: [],
    //脚本
    Script: 'SWL:(EMA(CLOSE,5)*7+EMA(CLOSE,10)*3)/10;\n\
...
JSIndexScript.prototype.CYR = function() {
  let data = {
    ...
    //脚本
    Script: 'DIVE:=0.01*EMA(AMOUNT,N)/EMA(VOL,N);\n\
...
JSIndexScript.prototype.MASS = function() {
  let data = {
    ...
    //脚本
    Script: 'MASS:SUM(MA(HIGH-LOW,N1)/MA(MA(HIGH-LOW,N1),N1),N2);\n\
MAMASS:MA(MASS,M);',
  };
...
JSIndexScript.prototype.CHO = function() {
  let data = {
    ...
    //脚本
    Script: 'MID:=SUM(VOL*(2*CLOSE-HIGH-LOW)/(HIGH+LOW),0);\n\
...
JSIndexScript.prototype.HSL = function() {
  let data = {
    ...
    Args: [{ Name: 'N', Value: 5 }],
    //脚本
    Script: 'HSL:IF((SETCODE==0||SETCODE==1),100*VOL,VOL)/(FINANCE(7)/100);\n\
MAHSL:MA(HSL,N);',
  };
...
JSIndexScript.prototype.BIAS36 = function() {
  let data = {
    ...
    Args: [{ Name: 'M', Value: 6 }],
    //脚本
    Script: 'BIAS36:MA(CLOSE,3)-MA(CLOSE,6);\n\
...
JSIndexScript.prototype.BIAS_QL = function() {
  let data = {
    ...
    //脚本
    Script: 'BIAS :(CLOSE-MA(CLOSE,N))/MA(CLOSE,N)*100;\n\
BIASMA :MA(BIAS,M);',
  };
...
JSIndexScript.prototype.DPO = function() {
  let data = {
    ...
    //脚本
    Script: 'DPO:CLOSE-REF(MA(CLOSE,N),N/2+1);\n\
MADPO:MA(DPO,M);',
  };
...
JSIndexScript.prototype.OSC = function() {
  let data = {
    ...
    //脚本
    Script: 'OSC:100*(CLOSE-MA(CLOSE,N));\n\
MAOSC:EXPMEMA(OSC,M);',
  };
...
JSIndexScript.prototype.ATR = function() {
  let data = {
    ...
    Args: [{ Name: 'N', Value: 14 }],
    //脚本
    Script: 'MTR:MAX(MAX((HIGH-LOW),ABS(REF(CLOSE,1)-HIGH)),ABS(REF(CLOSE,1)-LOW));\n\
ATR:MA(MTR,N);',
  };
...
JSIndexScript.prototype.NVI = function() {
  let data = {
    ...
    //脚本
    Script: 'NVI:100*MULAR(IF(V<REF(V,1),C/REF(C,1),1),0);\n\
MANVI:MA(NVI,N);',
  };
...
JSIndexScript.prototype.FKX = function() {
  let data = {
    ...
    Args: [],
    //脚本
    Script: 'DRAWKLINE(-LOW, -OPEN, -HIGH, -CLOSE);',
  };
...
JSIndexScript.prototype.UDL = function() {
  let data = {
    ...
    //脚本
    Script: 'UDL:(MA(CLOSE,N1)+MA(CLOSE,N2)+MA(CLOSE,N3)+MA(CLOSE,N4))/4;\n\
MAUDL:MA(UDL,M);',
  };
...
JSIndexScript.prototype.LWR = function() {
  let data = {
    ...
    //脚本
    Script: 'RSV:= (HHV(HIGH,N)-CLOSE)/(HHV(HIGH,N)-LLV(LOW,N))*100;\n\
LWR1:SMA(RSV,M1,1);\n\
LWR2:SMA(LWR1,M2,1);',
  };
...
JSIndexScript.prototype.CYD = function() {
  let data = {
    ...
    //脚本
    Script: 'CYDS:WINNER(CLOSE)/(VOL/CAPITAL);\n\
...
JSIndexScript.prototype.CYF = function() {
  let data = {
    ...
    Args: [{ Name: 'N', Value: 21 }],
    //脚本
    Script: 'CYF:100-100/(1+EMA(HSL,N));',
  };
...
JSIndexScript.prototype.VMACD = function() {
  let data = {
    ...
    //脚本
    Script: 'DIF:EMA(VOL,SHORT)-EMA(VOL,LONG);\n\
DEA:EMA(DIF,MID);\n\
...
JSIndexScript.prototype.QACD = function() {
  let data = {
    ...
    //脚本
    Script: 'DIF:EMA(CLOSE,N1)-EMA(CLOSE,N2);\n\
MACD:EMA(DIF,M);\n\
DDIF:DIF-MACD;',
  };
...
JSIndexScript.prototype.VPT = function() {
  let data = {
    ...
    //脚本
    Script: 'VPT:SUM(VOL*(CLOSE-REF(CLOSE,1))/REF(CLOSE,1),N);\n\
MAVPT:MA(VPT,M);',
  };
...
JSIndexScript.prototype.WVAD = function() {
  let data = {
    ...
    //脚本
    Script: 'WVAD:SUM((CLOSE-OPEN)/(HIGH-LOW)*VOL,N)/10000;\n\
MAWVAD:MA(WVAD,M);',
  };
...
JSIndexScript.prototype.JS = function() {
  let data = {
    ...
    //脚本
    Script: 'JS:100*(CLOSE-REF(CLOSE,N))/(N*REF(CLOSE,N));\n\
MAJS1:MA(JS,M1);\n\
MAJS2:MA(JS,M2);\n\
MAJS3:MA(JS,M3);',
  };
...
JSIndexScript.prototype.PCNT = function() {
  let data = {
    ...
    Args: [{ Name: 'M', Value: 5 }],
    //脚本
    Script: 'PCNT:(CLOSE-REF(CLOSE,1))/CLOSE*100;\n\
...
JSIndexScript.prototype.HSCOL = function() {
  let data = {
    ...
    Args: [{ Name: 'N', Value: 5 }],
    //脚本
    Script: 'HSCOL:IF((SETCODE==0||SETCODE==1),100*VOL,VOL)/(FINANCE(7)/100),VOLSTICK;\n\
MAHSL:MA(HSCOL,N);',
  };
...
JSIndexScript.prototype.DBQRV = function() {
  let data = {
    Name: 'DBQRV',
    Description: '对比强弱量(需下载日线)',
    IsMainIndex: false,
    Args: [{ Name: 'N', Value: 5 }],
    //脚本
    Script: 'ZS:(INDEXV-REF(INDEXV,N))/REF(INDEXV,N);\n\
...
JSIndexScript.prototype.VMA = function() {
  let data = {
    ...
    //脚本
    Script: 'VV:=(HIGH+OPEN+LOW+CLOSE)/4;\n\
VMA1:MA(VV,M1);\n\
VMA2:MA(VV,M2);\n\
VMA3:MA(VV,M3);\n\
VMA4:MA(VV,M4);\n\
...
JSIndexScript.prototype.SG_LB = function() {
  let data = {
    Name: 'SG-LB',
    Description: '量比(需下载日线)',
    IsMainIndex: false,
    Args: [],
    //脚本
    Script: 'ZY2:=VOL/INDEXV*1000;\n\
量比:ZY2;\n\
MA5:MA(ZY2,5);\n\
MA10:MA(ZY2,10);',
  };
...
JSIndexScript.prototype.ADVOL = function() {
  let data = {
    ...
    Args: [],
    //脚本
    Script: 'A:=SUM(((CLOSE-LOW)-(HIGH-CLOSE))*VOL/10000/(HIGH-LOW),0);\n\
ADVOL:A;\n\
MA1:MA(A,30);\n\
MA2:MA(MA1,100);',
  };
...
JSIndexScript.prototype.CYS = function() {
  let data = {
    ...
    Args: [],
    //脚本
    Script: 'CYC13:EMA(AMOUNT,13)/EMA(VOL,13);\n\
...
JSIndexScript.prototype.CYQKL = function() {
  let data = {
    ...
    Args: [],
    //脚本
    Script: 'KL:100*(WINNER(CLOSE)-WINNER(OPEN));',
  };
...
JSIndexScript.prototype.ASR = function() {
  let data = {
    ...
    Args: [],
    //脚本
    Script: 'ASR:(WINNER(C*1.1)-WINNER(C*0.9))/WINNER(HHV(H,0))*100;',
  };
...
JSIndexScript.prototype.SAR = function() {
  let data = {
    ...
    //脚本
    Script: 'S:SAR(P,STEP,MAXP),CIRCLEDOT;',
  };
...
JSIndexScript.prototype.UpDownAnalyze = function() {
  let data = {
    ...
    Args: [],
    //脚本
    Script: "上涨家数:UPCOUNT('CNA.CI'),COLORRED;\n\
...
JSIndexScript.prototype.HK2SHSZ = function() {
  let data = {
    ...
    Args: [],
    //脚本
    Script: '净流入:HK2SHSZ(1),COLORSTICK;',
  };
...
JSIndexScript.prototype.VOLRate = function() {
  let data = {
    ...
    Description: '量比',
    IsMainIndex: false,
    Condition: { Period: [CONDITION_PERIOD.MINUTE_ID, CONDITION_PERIOD.MULTIDAY_MINUTE_ID] },
    Args: [],
    //脚本
    Script: 'LIANGBI:VOLR;',
  };
...
JSIndexScript.prototype.COLOR_KSTAR1 = function() {
  let data = {
    ...
    InstructionType: 2,
    //脚本
    Script: 'KSTAR:CLOSE==OPEN&&HIGH>LOW;',
  };
...
JSIndexScript.prototype.COLOR_SHI1 = function() {
  let data = {
    ...
    InstructionType: 2,
    //脚本
    Script: 'KSTAR:CLOSE==OPEN&&HIGH/LOW>1.03;',
  };
...
JSIndexScript.prototype.COLOR_K300 = function() {
  let data = {
    ...
    InstructionType: 2,
    //脚本
    Script: 'KSTAR:UPNDAY(CLOSE,3)&&NDAY(CLOSE,OPEN,3);',
  };
...
JSIndexScript.prototype.COLOR_K310 = function() {
  let data = {
    ...
    InstructionType: 2,
    //脚本
    Script: 'KSTAR:DOWNNDAY(CLOSE,3)&&NDAY(OPEN,CLOSE,3);',
  };
...
JSIndexScript.prototype.COLOR_K380 = function() {
  let data = {
    ...
    InstructionType: 2,
    //脚本
    Script: 'KSTAR:HIGH==CLOSE&&HIGH>LOW;',
  };
...
JSIndexScript.prototype.COLOR_K390 = function() {
  let data = {
    ...
    InstructionType: 2,
    //脚本
    Script: 'KSTAR:LOW==CLOSE&&HIGH>LOW;',
  };
...
JSIndexScript.prototype.COLOR_K134 = function() {
  let data = {
    ...
    InstructionType: 2,
    //脚本
    Script: 'KSTAR:CLOSE==OPEN&&CLOSE==LOW&&CLOSE<HIGH;',
  };
...
JSIndexScript.prototype.COLOR_K160 = function() {
  let data = {
    ...
    InstructionType: 2,
    //脚本
    Script: 'KSTAR:MIN(OPEN,CLOSE)==LOW&&\n\
...
JSIndexScript.prototype.COLOR_K170 = function() {
  let data = {
    ...
    InstructionType: 2,
    //脚本
    Script: 'OUT:HIGH==MAX(OPEN,CLOSE)&&\n\
...
JSIndexScript.prototype.COLOR_PINGDING = function() {
  let data = {
    ...
    InstructionType: 2,
    //脚本
    Script: 'VAR1:BACKSET(ABS(HIGH-REF(HIGH,1))/HIGH<0.001,2);',
  };
...
JSIndexScript.prototype.COLOR_PINGDI = function() {
  let data = {
    ...
    InstructionType: 2,
    //脚本
    Script: 'VAR1:BACKSET((ABS(LOW-REF(LOW,1))/LOW<0.001 AND \n\
...
JSIndexScript.prototype.COLOR_DAYANZHU = function() {
  let data = {
    ...
    InstructionType: 2,
    //脚本
    Script: 'VAR1:CLOSE/OPEN>1.05 AND HIGH/LOW < CLOSE/OPEN+0.018;',
  };
...
JSIndexScript.prototype.COLOR_DAYINGZHU = function() {
  let data = {
    ...
    InstructionType: 2,
    //脚本
    Script: 'VAR1:OPEN/CLOSE > 1.05 AND HIGH/LOW < OPEN/CLOSE+0.018;',
  };
...
JSIndexScript.prototype.COLOR_HYFG = function() {
  let data = {
    ...
    InstructionType: 2,
    //脚本
    Script: 'VAR1:BACKSET( (REF(CLOSE,1)<REF(OPEN,1) AND \n\
...
JSIndexScript.prototype.COLOR_TKQK = function() {
  let data = {
    ...
    InstructionType: 2,
    //脚本
    Script: 'VAR1:BACKSET( HIGH<REF(LOW,1) OR LOW>REF(HIGH,1),2);',
  };
...
JSIndexScript.prototype.COLOR_SFWY = function() {
  let data = {
    ...
    InstructionType: 2,
    //脚本
    Script: 'VAR1:BACKSET( REF(CLOSE,1)<REF(OPEN,1) AND CLOSE<OPEN AND CLOSE/OPEN<0.98,1);',
  };
...
JSIndexScript.prototype.COLOR_CHXY = function() {
  let data = {
    ...
    InstructionType: 2,
    //脚本
    Script: 'VAR2:(MIN(CLOSE,OPEN)-LOW)/(HIGH-LOW)>0.667;',
  };
...
JSIndexScript.prototype.COLOR_CHSY = function() {
  let data = {
    ...
    InstructionType: 2,
    //脚本
    Script: 'VAR2:(HIGH-MAX(CLOSE,OPEN))/(HIGH-LOW)>0.667,COLORBLUE;',
  };
...
JSIndexScript.prototype.COLOR_FENLI = function() {
  let data = {
    ...
    InstructionType: 2,
    //脚本
    Script: 'VAR1:BACKSET( OPEN==REF(OPEN,1) AND (CLOSE-OPEN)*(REF(CLOSE,1)-REF(OPEN,1))<0,2);',
  };
...
JSIndexScript.prototype.TRADE_MA = function() {
  let data = {
    ...
    //脚本
    Script: 'ENTERLONG:CROSS(MA(CLOSE,SHORT),MA(CLOSE,LONG));\n\
...
JSIndexScript.prototype.TRADE_MTM = function() {
  let data = {
    Name: 'MTM',
    Description: '动力指标专家系统',
    IsMainIndex: true,
    InstructionType: 1,
    Args: [{ Name: 'N', Value: 6 }],
    //脚本
    Script: 'WMTM:=C-REF(C,N);\n\
...
JSIndexScript.prototype.TRADE_PSY = function() {
  let data = {
    ...
    //脚本
    Script: 'MYPSY:=COUNT(CLOSE>REF(CLOSE,1),N)/N*100;\n\
...
JSIndexScript.prototype.TRADE_ROC = function() {
  let data = {
    ...
    //脚本
    Script: 'WROC:=MA(100*(CLOSE-REF(CLOSE,N))/REF(CLOSE,N),M);\n\
  ...
  let data = {
    ...
    Condition: {
      Period: [
        CONDITION_PERIOD.KLINE_DAY_ID,
        CONDITION_PERIOD.KLINE_WEEK_ID,
        CONDITION_PERIOD.KLINE_TWOWEEK_ID,
        CONDITION_PERIOD.KLINE_MONTH_ID,
        CONDITION_PERIOD.KLINE_QUARTER_ID,
        CONDITION_PERIOD.KLINE_YEAR_ID,
      ],
    ...
    Args: [{ Name: 'M', Value: 7 }],
    //脚本
    Script: 'ADL:SUM(ADVANCE-DECLINE,0);\n\
MAADL:MA(ADL,M);',
  };
...
JSIndexScript.prototype.DC = function() {
  let data = {
    ...
    //脚本
    Script: 'UPPER:HHV(H,N1),COLORBLUE,LINETHICK2;\n\
...
JSIndexScript.prototype.DEMA = function() {
  let data = {
    Name: 'DEMA',
    Description: '双重指数移动均线',
    IsMainIndex: true,
    Args: [{ Name: 'N1', Value: 10 }],
    //脚本
    Script: 'ERR:=C-EMA(C,N1);\n\
...
JSIndexScript.prototype.ZSDB = function() {
  let data = {
    Name: 'ZSDB',
    Description: '指数对比(副图,需下载日线)',
    IsMainIndex: false,
    //脚本
    Script: 'A:=REF(INDEXC,1);\n\
...
JSIndexScript.prototype.TEST = function() {
  let data = {
    ...
    Args: [{ Name: 'N', Value: 10 }],
    //脚本
    Script: "DRAWCHANNEL(OPEN>C,H,L, 'RGB(255,94,102)', 2 ,'5,5','RGBA(58,20,62,0.3)' );",
  };
